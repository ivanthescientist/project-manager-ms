...
public class ProjectController {
    ...
    public ProjectDTO findById(@PathVariable Long id) {
        return service.findById(id).orElseThrow(() -> new EntityNotFoundException("Project", id.toString()));
    }
    ...
    public ProjectDTO update(@RequestBody ProjectDTO projectDTO, @PathVariable Long id) {
        projectDTO.setId(id);
        return service.update(projectDTO).orElseThrow(() -> new EntityNotFoundException("Project", id.toString()));
    }
